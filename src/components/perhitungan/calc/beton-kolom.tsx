...
const useCalcBetonKolom = (setTabelKolom: SetTabelKolomProps) => {
    ...
    const calcKolom = (data: KolomData) => {
        ...
        const convSemen = bSemen.toLocaleString('id-ID', { minimumFractionDigits: 3, maximumFractionDigits: 3 })
        const convPasir = bPasir.toLocaleString('id-ID', { minimumFractionDigits: 3, maximumFractionDigits: 3 })
        const convKerikil = bKerikil.toLocaleString('id-ID', { minimumFractionDigits: 3, maximumFractionDigits: 3 })
...
export default useCalcBetonKolom
