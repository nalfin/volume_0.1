...
const useCalcPembesianSloof = (setTabelSloof: SetTabelSloofProps) => {
    ...
    const calcSloof = (data: SloofData) => {
        ...
        // SENGKANG TUMPUAN
        const pjGelSTum = kePS - 8 * tSB + 2 * 8 * dTS
        ...
        // SENGKANG LAPANGAN
        const pjGelSLap = kePS - 8 * tSB + 2 * 8 * dTS
...
export default useCalcPembesianSloof
