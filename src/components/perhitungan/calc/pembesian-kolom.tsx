...
const useCalcPembesianKolom = (setTabelKolom: SetTabelKolomProps) => {
    ...
    const calcKolom = (data: KolomData) => {
        ...
        const dTT = diaTulT
        const nTY = jmlTulY ? parseFloat(jmlTulY) : 0
        const nTX = jmlTulX ? parseFloat(jmlTulX) : 0
...
export default useCalcPembesianKolom
