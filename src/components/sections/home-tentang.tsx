...
const cardTentang = [
    ...
    },
    {
        ...
        title: 'TEPAT',
        description:
            'Perhitungan volume sesuai SNI terbaru dan dihitung menggunakan sistem'
    }
]
    ...
    return (
        <ContainerFull className="bg-header">
            <Container>
                <div
                    id="tentang-kami"
                    className="flex flex-col gap-10 py-20 lg:py-[120px]"
                >
                    <div className="flex flex-col items-center gap-8 text-base-light">
                        ...
                        <div className="w-full lg:w-[1200px]">
                            <p className="text-center text-[18px] leading-[150%]">
                                Kalkulator volume pekerjaan bangunan yang dibuat
                                oleh tim. untuk menghitung kebutuhan bahan dan
                                volume bangunan. yang telah membantu banyak
                                orang untuk merencanakan proyek dengan aplikasi
                                berbasis web untuk kebutuhan bahan material dan
                                volume item pekerjaan. yang dapat dikerjakan
